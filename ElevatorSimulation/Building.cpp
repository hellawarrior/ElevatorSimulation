...
void Building::action(double arrivalsPerSecond)
{
  ...
  {
    if (openDoorToDisembarkRider(e)) continue; // lab 7
    if (disembarkRider(e)) continue; // lab 8
    if (boardRider(e)) continue; // lab 8
    //if (waitingForMoreRiders(e)) continue; // lab 12
    //if (doneWaitingMove(e)) continue; // lab 12
    //if (moveableMove(e)) continue; // lab 14
    //if (setIdleElevatorInMotion(e)) continue; // lab 14
    //if (sendIdleElevatorToCallingFloor(e)) continue; // lab 14
    //elevators[e].goIdle(); // nothing to do
  }
}

bool Building::disembarkRider(int e) // lab 8
{
...
bool Building::boardRider(int e) // lab 8
{ 
